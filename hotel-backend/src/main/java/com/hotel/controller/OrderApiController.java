...
import com.hotel.model.dto.CartCheckoutRequest;
...
public class OrderApiController {
  ...
  public ResponseEntity<?> createOrder(
    ...
    try {
      CustomerOrder order =
          orderService.createOrder(memberId, request.getCouponCode(), request.getItems());
  ...
  public ResponseEntity<?> createOrderFromCart(
    ...
    CustomerOrder order =
        orderService.createOrderFromCart(authentication.getName(), request.getCouponCode());
    return ResponseEntity.ok(order);
  }
  ...
  public ResponseEntity<?> getMemberOrders(
      @PathVariable String memberId, Authentication authentication) {
    ...
    try {
      ...
      List<OrderDTO> orders = orderService.getOrdersByMemberId(id);

      return ResponseEntity.ok(orders);
    } catch (NumberFormatException e) {
      return ResponseEntity.badRequest().body(Map.of("message", "無效的會員編號"));
    }
  }
  ...
  public ResponseEntity<Void> updateOrderItemQuantity(
    ...
    orderService.updateOrderItemQuantity(orderId, productId, quantity);
  ...
  public ResponseEntity<List<MonthlyOrderStatisticsDTO>> getMonthlyOrderStatistics() {
    ...
    return ResponseEntity.ok(orderService.getMonthlyOrderStatistics());
  }
  ...
  public ResponseEntity<List<MonthlyProductSalesDTO>> getMonthlyProductSales(
    ...
    List<MonthlyProductSalesDTO> result = orderService.getMonthlyProductSales(year, month);
