...
export const memberApi = {
  ...
  getMyProfile() {
    return fetchClient(`${BASE_URL}/me`, { method: "GET" });
  },

  updateMyProfile(data) {
    return fetchClient(`${BASE_URL}/me`, {
      method: "PUT",
      body: data,
    });
  },
  ...
  changeMyPassword(data) {
    return fetchClient(`${BASE_URL}/me/password`, {
      method: "PUT",
      body: data,
    });
  },
