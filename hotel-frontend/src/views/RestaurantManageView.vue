                ...
                <form @submit.prevent="saveRestaurant">
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input id="restaurantName" v-model.trim="form.restaurantName" type="text"
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="description" v-model.trim="form.description" placeholder="請輸入餐廳特色與介紹" />
                        </div>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr v-for="restaurant in restaurants" :key="restaurant.restaurantId">
                                ...
                                <td class="actions">
                                    <button type="button" class="btn-edit" @click="editRestaurant(restaurant)">
                                        修改
                                    </button>
