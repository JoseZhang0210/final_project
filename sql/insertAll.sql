-- =========================================================
-- finalproject 初始化資料（修正版）
-- 請在「全新建立、尚未灌入測試資料」的 finalproject 上執行
-- 已修正：
-- 1. 移除不必要的 IDENTITY_INSERT
-- 2. room_type -> room -> room_image -> booking 的 FK 順序
-- 3. Product 欄位與 CREATE TABLE 對齊為 ImageURL
-- 4. 新增 payment_id = 5 所需的第 5 筆 payment
-- 5. rental_payment 先於 rental 建立
-- 6. 移除 TRUNCATE TABLE room
-- =========================================================
USE [finalproject];
GO
   /* =========================================================
