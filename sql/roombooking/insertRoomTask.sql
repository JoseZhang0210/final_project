...
--     -- completed_at: 僅 task_status 為「已完成」時計算完成時間，其餘為 NULL
--     CASE 
--         WHEN task_status = N'已完成' THEN DATEADD(MINUTE, rand_complete_min, created_at)
--         ELSE NULL 
--     END AS completed_at
...
-- FROM (
--     SELECT TOP (3)  -- 產生 3 筆任務
--         -- room_id: 在 1 ~ 120 號房之間隨機挑選
--         (ABS(CHECKSUM(NEWID())) % 120) + 1 AS room_id,
        
--         -- employee_id: 固定指定給唯一的房務人員 (ID = 4)
--         4 AS employee_id,
